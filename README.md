...
**Walkthrough video (4:51, captioned):** <https://drive.google.com/file/d/1xZNcK_YuHYiSp9h2Iq1FtRZJ9oPKlPRK/view>
**Source + docs + video (Google Drive folder):** <https://drive.google.com/drive/folders/1EXcbWzbjVegdhpeT5qu0DL8GhfukmW74>
...
- **Live updates** - when a collaborator saves, other clients viewing the same document pull the change in automatically over Supabase Realtime. If you happen to be mid-edit, it does not yank the document out from under you: you get an "updated - Load latest" banner and apply it when you are ready.
